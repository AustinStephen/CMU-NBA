...
density_drives_2014_15 <- read.csv("./data/density_distance_drives_tracking/_density_drives_distance_daily_2014_15.csv")
```
...
(sum(other_2014$drive_pts_pct)) / nrow(other_2014) 



(sum(b2b_2014$drive_pts_pct)) / nrow(b2b_2014) 

```

```{r drives_point_pct, echo = false}
...
other_2014 %>%
  ...
  group_by(player_id) %>%
  filter(team_abbreviation == "DAL") %>%
  ggplot(aes(x = player_name, y = (sum(drive_pts_pct)) / nrow(other_2014))) +
  geom_bar(stat = "Identity") +
  geom_bar(data = b2b_2014_DAL, aes(x = player_name, y = (sum(drive_pts_pct)) / nrow(b2b_2014_DAL)), 
           stat = "Identity", color = "red", position = "dodge") +
  theme_bw()
...
other_2014 %>%
  ...
  ggplot(aes(x = player_name, y = (sum(drive_pts_pct)) / nrow(other_2014))) +
  geom_bar(stat = "Identity") +
  geom_bar(data = b2b_2014_LAC, aes(x = player_name, y = (sum(drive_pts_pct)) / nrow(b2b_2014_LAC)), 
           stat = "Identity", color = "red", position = "dodge") +
  theme_bw()
...
other_2014 %>%
  ...
  ggplot(aes(x = player_name, y = ((sum(drive_pts_pct)) / nrow(other_2014)))) +
  geom_bar(stat = "Identity") +
  geom_bar(data = b2b_2014_ATL, aes(x = player_name, y = ((sum(drive_pts_pct)) / nrow(b2b_2014_ATL))), 
           stat = "Identity", color = "red", position = "dodge") +
  theme_bw()
...
other_2014 %>%
  ...
  ggplot(aes(x = player_name, y = ((sum(drive_pts_pct)) / nrow(other_2014)))) +
  geom_bar(stat = "Identity") +
 #geom_bar(data = b2b_2014_GSW, aes(x = player_name, y = ((sum(drive_pts_pct)) / nrow(b2b_2014_GSW))), 
           #stat = "Identity", color = "red", position = "dodge") +
  theme_bw()
...
density_drives_2014_15 %>%
  ...
  group_by(player_id) %>%
  filter(team_abbreviation == "GSW") %>%
  ggplot(aes(x = player_name, y = ((sum(drive_pts_pct)) / nrow(density_drives_2014_15)))) +
  geom_bar(stat = "Identity") +
  theme_bw()
...
ggplot(data = b2b_2014_ATL, aes(x = player_name, y = ((sum(b2b_2014_ATL$drive_pts_pct)) / nrow(b2b_2014_ATL)))) +
  geom_bar(stat = "Identity") +
  theme_bw()
...
```{r aggregate drives pct, echo=FALSE}
...
b2b_2014_DAL %>%
  ...
  filter(player_name == "Dirk Nowitzki") %>%
  pull(drive_pts_pct) %>%
  sum() / nrow(b2b_2014_DAL)

b2b_2014 %>%
  filter(drives > 0) %>%
  group_by(player_id) %>%
  filter(player_name == "DAL") %>%
