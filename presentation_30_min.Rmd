...
2. Offer a framework for analyzing fatigue
...
### Identifying contribution to game outcome  

- Response is game outcome 

- Predictors are any event contributing to that outcome

- Most important factor is team strength 

- Extract relationships with the game outcome that are present once the team
strength has been eliminated from the picture
