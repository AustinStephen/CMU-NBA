...
ggplot(data = speed_table) +
  ...
  xlab("Season") +
  ylab("Mean speed") +
  labs(title = "Difference of Means 2nd Game of a Back to Back and Other Games", colour = "game type") +
  theme(panel.background = element_rect(fill = "burlywood"),
        panel.grid.major=element_blank())  +
...
### Types of models for team strength  
...
### Preformance of team strength models  
